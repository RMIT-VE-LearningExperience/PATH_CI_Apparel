...
Nothing regressed from the *intended* Steps-layout work — A5's improvement is real, and the new A12 regression was a small, contained fix, now resolved. But this confirms none of the larger baseline findings (A4 main landmark, A6 dialog semantics, A7 nav labels, A8 tab semantics, A9 titles, A10 live region) got fixed as side effects, and the video-caption finding (A3) is now clearly live rather than hypothetical. These are still open and would need their own scoped pass.
